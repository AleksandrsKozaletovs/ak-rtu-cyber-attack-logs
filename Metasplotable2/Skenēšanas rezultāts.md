...
=======================================
```
Starting Nmap 7.95 ( https://nmap.org ) at 2025-05-15 21:50 EEST
...
Initiating NSE at 21:50
Completed NSE at 21:50, 0.00s elapsed
Initiating ARP Ping Scan at 21:50
Scanning 192.168.1.200 [1 port]
Completed ARP Ping Scan at 21:50, 0.04s elapsed (1 total hosts)
...
Completed SYN Stealth Scan at 21:50, 0.12s elapsed (1000 total ports)
...
Warning: Hit PCRE_ERROR_MATCHLIMIT when probing for service http with the regex '^HTTP/1\.1 \d\d\d (?:[^\r\n]*\r\n(?!\r\n))*?.*\r\nServer: Virata-EmWeb/R([\d_]+)\r\nContent-Type: text/html; ?charset=UTF-8\r\nExpires: .*<title>HP (Color |)LaserJet ([\w._ -]+)&nbsp;&nbsp;&nbsp;'
Completed Service scan at 21:50, 11.21s elapsed (6 services on 1 host)
Initiating OS detection (try #1) against 192.168.1.200
NSE: Script scanning 192.168.1.200.
NSE: Starting runlevel 1 (of 3) scan.
Initiating NSE at 21:50
Completed NSE at 21:50, 0.73s elapsed
NSE: Starting runlevel 2 (of 3) scan.
Initiating NSE at 21:50
Completed NSE at 21:50, 1.01s elapsed
NSE: Starting runlevel 3 (of 3) scan.
Initiating NSE at 21:50
Completed NSE at 21:50, 0.00s elapsed
Nmap scan report for 192.168.1.200
Host is up, received arp-response (0.0035s latency).
Scanned at 2025-05-15 21:50:18 EEST for 15s
...
|     Last-Modified: Thu, 15 May 2025 18:30:47 GMT
|     ETag: W/"11708-196d5369adb"
|     Content-Type: text/html; charset=UTF-8
|     Content-Length: 71432
|     Vary: Accept-Encoding
|     Date: Thu, 15 May 2025 18:50:24 GMT
|     Connection: close
|     <!--
...
SF-Port8083-TCP:V=7.95%I=7%D=5/15%Time=68263770%P=x86_64-pc-linux-gnu%r(Ge
...
SF:\r\nLast-Modified:\x20Thu,\x2015\x20May\x202025\x2018:30:47\x20GMT\r\nE
SF:Tag:\x20W/\"11708-196d5369adb\"\r\nContent-Type:\x20text/html;\x20chars
SF:et=UTF-8\r\nContent-Length:\x2071432\r\nVary:\x20Accept-Encoding\r\nDat
SF:e:\x20Thu,\x2015\x20May\x202025\x2018:50:24\x20GMT\r\nConnection:\x20cl
...
SF:el=\"icon\"\x20")%r(FourOhFourRequest,3890,"HTTP/1\.1\x20200\x20OK\r\nA
SF:ccess-Control-Allow-Origin:\x20\*\r\nX-Content-Type-Options:\x20nosniff
SF:\r\nX-Frame-Options:\x20SAMEORIGIN\r\nFeature-Policy:\x20payment\x20'se
SF:lf'\r\nX-Recruiting:\x20/#/jobs\r\nAccept-Ranges:\x20bytes\r\nCache-Con
SF:trol:\x20public,\x20max-age=0\r\nLast-Modified:\x20Thu,\x2015\x20May\x2
SF:02025\x2018:30:47\x20GMT\r\nETag:\x20W/\"11708-196d5369adb\"\r\nContent
SF:-Type:\x20text/html;\x20charset=UTF-8\r\nContent-Length:\x2071432\r\nVa
SF:ry:\x20Accept-Encoding\r\nDate:\x20Thu,\x2015\x20May\x202025\x2018:50:2
SF:4\x20GMT\r\nConnection:\x20close\r\n\r\n<!--\n\x20\x20~\x20Copyright\x2
SF:0\(c\)\x202014-2025\x20Bjoern\x20Kimminich\x20&\x20the\x20OWASP\x20Juic
SF:e\x20Shop\x20contributors\.\n\x20\x20~\x20SPDX-License-Identifier:\x20M
SF:IT\n\x20\x20-->\n\n<!doctype\x20html>\n<html\x20lang=\"en\"\x20data-cri
...
SF:0<link\x20id=\"favicon\"\x20rel=\"icon\"\x20");
...
TCP/IP fingerprint:
OS:SCAN(V=7.95%E=4%D=5/15%OT=22%CT=1%CU=39498%PV=Y%DS=1%DC=D%G=Y%M=000C29%T
OS:M=68263779%P=x86_64-pc-linux-gnu)SEQ(SP=102%GCD=1%ISR=10F%TI=Z%CI=Z%II=I
...
Uptime guess: 27.244 days (since Fri Apr 18 15:59:50 2025)
