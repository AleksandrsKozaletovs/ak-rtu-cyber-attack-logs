...
=======================================
```
Starting Nmap 7.95 ( https://nmap.org ) at 2025-05-17 17:55 EEST
...
Completed ARP Ping Scan at 17:55, 0.04s elapsed (1 total hosts)
...
Completed SYN Stealth Scan at 17:55, 0.09s elapsed (1000 total ports)
...
Warning: Hit PCRE_ERROR_MATCHLIMIT when probing for service http with the regex '^HTTP/1\.1 \d\d\d (?:[^\r\n]*\r\n(?!\r\n))*?.*\r\nServer: Virata-EmWeb/R([\d_]+)\r\nContent-Type: text/html; ?charset=UTF-8\r\nExpires: .*<title>HP (Color |)LaserJet ([\w._ -]+)&nbsp;&nbsp;&nbsp;'
Completed Service scan at 17:55, 11.28s elapsed (6 services on 1 host)
Initiating OS detection (try #1) against 192.168.1.200
NSE: Script scanning 192.168.1.200.
NSE: Starting runlevel 1 (of 3) scan.
Initiating NSE at 17:55
Completed NSE at 17:55, 0.84s elapsed
NSE: Starting runlevel 2 (of 3) scan.
Initiating NSE at 17:55
Completed NSE at 17:55, 1.01s elapsed
NSE: Starting runlevel 3 (of 3) scan.
Initiating NSE at 17:55
Completed NSE at 17:55, 0.00s elapsed
Nmap scan report for 192.168.1.200
Host is up, received arp-response (0.00086s latency).
Scanned at 2025-05-17 17:55:29 EEST for 14s
...
|     Date: Sat, 17 May 2025 14:55:35 GMT
|     Connection: close
|     <!--
...
SF-Port8083-TCP:V=7.95%I=7%D=5/17%Time=6828A367%P=x86_64-pc-linux-gnu%r(Ge
...
SF:e:\x20Sat,\x2017\x20May\x202025\x2014:55:35\x20GMT\r\nConnection:\x20cl
...
SF:trol:\x20public,\x20max-age=0\r\nLast-Modified:\x20Sat,\x2017\x20May\x2
SF:02025\x2014:54:21\x20GMT\r\nETag:\x20W/\"11708-196debd2c49\"\r\nContent
SF:-Type:\x20text/html;\x20charset=UTF-8\r\nContent-Length:\x2071432\r\nVa
SF:ry:\x20Accept-Encoding\r\nDate:\x20Sat,\x2017\x20May\x202025\x2014:55:3
...
TCP/IP fingerprint:
OS:SCAN(V=7.95%E=4%D=5/17%OT=22%CT=1%CU=38054%PV=Y%DS=1%DC=D%G=Y%M=000C29%T
OS:M=6828A36F%P=x86_64-pc-linux-gnu)SEQ(SP=107%GCD=1%ISR=10A%TI=Z%CI=Z%TS=A
...
Uptime guess: 35.915 days (since Fri Apr 11 19:57:50 2025)
